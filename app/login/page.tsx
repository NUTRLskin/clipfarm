  ...
  return (
    <div style={{minHeight:"100vh",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",background:"#0e0e10",padding:"24px"}}>
      <div style={{width:"100%",maxWidth:380,textAlign:"center"}}>
        ...
        <div style={{fontSize:14,color:"#6b6b7a",marginBottom:40}}>Post clips. Earn money.</div>

        <div style={{background:"#18181b",borderRadius:16,border:"1px solid rgba(255,255,255,0.08)",padding:"28px 22px"}}>
          <div style={{fontSize:18,fontWeight:500,marginBottom:6,color:"#efeff1"}}>Choose how you want to sign in</div>
          <div style={{fontSize:13,color:"#adadb8",marginBottom:22}}>You can switch between modes later from the app.</div>
